...
import images from "../images/icon.jpg";
...
const Header=()=>{
    ...
    const status=()=>{
        toast.success(`${user.name} can I order a Bhojan for you 😋? `, {
    ...
    return(
        ...
        }}><img className="logo" src={images}/></NavLink>
        ...
        <div className="nav-items">
            <ul>
               ...
               <li className="button-2" role="button" onClick={()=>{
                ...
                {/* If you are offline show red dot  */}
                { !isLoading && !onlineStatus &&
                <p>
                    {
                    isAuthenticated  ?
